...
const IndividualProfile = () => {
  return (
    <div className="h-[95%] w-[90%] bg-white shadow-md p-10 -z-10 mobile:w-full mobile:h-full mobile:p-3">
      <div>
      ...
      <div className="flex items-center">
        <div>
          <div className="h-[250px] w-[200%] bg-white shadow-xl rounded-xl mobile:w-full">
