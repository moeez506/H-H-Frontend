...
const Step6 = ({ currentStep, handleNextStep }: Step6Props) => {
  ...
  const { representativeTwo, setRepresentativeTwo } =
  ...
  const {
    ...
    onSubmit: (values) => {
      setRepresentativeTwo((prevState) => {
        console.log("🚀 ~ file: Step6.tsx:94 ~ Step6 ~ prevState:", prevState);
        return { ...prevState, ...values };
      });
      console.log("🚀 ~ file: Step6.tsx:94 ~ Step6 ~ values:", values);
      handleNextStep(7);
    },
  });
