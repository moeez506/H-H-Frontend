...
const ContactBody = () => {
  return (
    <>
      ...
      <div className="flex justify-center items-center tabletOnly:flex-col mobile:flex-col">
        ...
        <div className="bg-white rounded-3xl shadow-black shadow-lg h-[830px] w-[780px] tabletOnly:w-[520px] pl-12 pt-16 pr-12 mobile:w-full">
          ...
          <form className="space-y-4 md:space-y-6" action="#">
            <div>
              ...
              <input
                ...
                name="name"
                id="name"
                className="border text-gray-900 sm:text-sm rounded-lg laptop:w-full p-3 dark:placeholder-gray-400"
                placeholder="Name*"
              />
            </div>
            <div>
            ...
            <div>
              <input
                ...
                className="border text-gray-900 sm:text-sm rounded-lg laptop:w-full p-3 dark:placeholder-gray-400 h-[160px]"
              />
            </div>
      ...
      <div className="flex items-center justify-center mt-12">
        <div className="bg-[#ececed] shadow-black shadow-xl rounded-2xl h-full w-[75%] mobile:w-full">
          <h1 className="text-6xl font-bold text-center text-orange pt-5">
            OUR LOCATIONS
          </h1>
