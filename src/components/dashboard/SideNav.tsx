...
//     // const laptopView = window.innerWidth >= 1024 ? true : false;
//     return (
//         <div className='flex flex-col'>
//         <div className='bg-[#0C1214] h-20 flex items-center'>
            
//         <button onClick={() => setOpen(!open)}>
//                             <svg
//                                 xmlns="http://www.w3.org/2000/svg"
//                                 className="w-10 h-10 text-white laptop:hidden"
//                                 fill="none"
//                                 viewBox="0 0 24 24"
//                                 stroke="currentColor"
//                                 strokeWidth={2}
...
//                             </svg>
//                         </button>
//                         <img src={logo} alt="no image found" className="h-16 w-16 tablet:h-14 tablet:w-18" />
...
//                                         />
//                                     </svg>
//                                     <NavLink to='/individual-Profile' className="text-gray-100 text-lg">Profile</NavLink>
//                                 </a>
//                             </li>
//                             <li className="rounded-sm">
//                                 <a
...
//                                         />
//                                     </svg>
//                                     <NavLink to='/individual-Inbox' className="text-gray-100 text-lg">Inbox</NavLink>
//                                 </a>
//                             </li>
//                             <li className="rounded-sm">
//                                 <a
